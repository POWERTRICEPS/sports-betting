...
function LazyImage({src, alt, width, height, maxRetries = 3} : {src: string, alt: string, width: number, height: number, maxRetries?: number}) {
                  ...
                  >
                    ...
                    <td className="py-2.5">
                      <div className = "flex items-center gap-2">
                        <LazyImage src={`https://a1.espncdn.com/combiner/i?img=/i/teamlogos/nba/500/scoreboard/${team.team_abbreviation}.png&h=456&w=456`} width={20} height={20} alt={`${team.team_city} ${team.team_name} logo`} />
